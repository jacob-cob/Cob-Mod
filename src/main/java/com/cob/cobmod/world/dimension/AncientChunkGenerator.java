...
public class AncientChunkGenerator extends NoiseChunkGenerator<AncientGenSettings> {
	...
	public AncientChunkGenerator(IWorld worldIn, BiomeProvider provider, AncientGenSettings settingsIn) {
